...
def preprocess_text_parse():
    ...
    preprocess_text_parser.add_argument(
        "--prepared_dpath", default="./data/prepared_data"
    )
    preprocess_text_parser.add_argument(
        "--intermediate_dpath", default="./data/intermediate_data"
    )
...
def wordtovec_parse_args():
    ...
    word2vec_parser.add_argument(
        "--playbook", default="./playbooks/word2vec_params.json"
    )
